                                ...
                                <div class="col-sm-6" style="display: none;" id="lkn-input-cnpj">
                                    <div>
                                        ...
                                        <input type="text" id="inputCNPJ" class="field form-control"
                                            ...
                                            oninput="this.value = maskCNPJ(this.value)" maxlength="18">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="text-center">
                    ...
                    <script>
                        function showSpinner(event) {
                            ...
                            if (!containerDiv) {
                                ...
                                if (formIsValid) {
                                    ...
                                    // Exibe o modal de erro apenas depois que todos os campos foram verificados
                        ...
                        function showErrorModal(missingFields) {
                            ...
                            list.innerHTML = ''; // Limpa qualquer lista anterior de campos faltantes
                        ...
                        // Função para remover a classe 'invalid-field' automaticamente ao detectar mudanças
                        function observeInvalidFields() {
                            const invalidFields = document.querySelectorAll('.invalid-field');

                            invalidFields.forEach((field) => {
                                if (!field.hasAttribute('data-observing')) {
                                    field.setAttribute('data-observing', 'true');
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            ...
                            // Observa campos inválidos automaticamente
                            observeInvalidFields();
                        });
                    </script>
