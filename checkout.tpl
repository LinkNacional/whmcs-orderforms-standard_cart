                                ...
                                <div class="col-sm-6" style="display: none;" id="lkn-input-cnpj">
                                    <div>
                                        ...
                                        <input type="text" id="inputCNPJ" class="field form-control"
                                            ...
                                            onchange="this.value = maskCNPJ(this.value)" maxlength="18">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            if (!containerDiv) {
                                ...
                                if (fullName && fullName.value.trim().split(" ").length < 2) {
                                    ...
                                    fullName.classList.add(
                                        'invalid-field'); // Adiciona a borda vermelha no campo de nome completo
                                }
                                ...
                                if (password1 && password2 && password1.value !== password2.value) {
                                    ...
                                    password2.classList.add(
                                        'invalid-field'); // Adiciona a borda vermelha na confirmação de senha
                                }
                                ...
                                if (formIsValid) {
                                    ...
                                    // Submete o formulário manualmente, buscando o formulário mais próximo do botão
