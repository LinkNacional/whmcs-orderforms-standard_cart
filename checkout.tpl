                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <input type="email" name="email" id="inputEmail" class="field form-control"
                                            placeholder="{$LANG.orderForm.emailAddress}" value="{$clientsdetails.email}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <input type="tel" name="phonenumber" id="inputPhone" class="field form-control"
                                            ...
                                            value="{$clientsdetails.phonenumber}" required>
                                    </div>
                                    {if $isWhatsappField}
                                        {$isWhatsappField}
                                    {/if}
                                ...
                                <div class="col-sm-6" style="display: flex">
                                    <div id="cpfField">
                                        ...
                                        <input type="text" name="inputCPF" id="inputCPF" class="field form-control"
                                            placeholder="123.456.789-10" oninput="this.value = maskCPF(this.value)"
                                            maxlength="14">
                                    </div>
