                                ...
                                <div class="col-sm-6" style="display: none;">
                                    <div>
                                        ...
                                        <input type="text" name="firstname" id="inputFirstName" class="field form-control"
                                            placeholder="{$LANG.orderForm.firstName}" required
                                            value="{$clientsdetails.firstname}" autofocus>
                                    </div>
                                </div>
                                <div class="col-sm-6" style="display: none;">
                                    <div class="form-group prepend-icon">
                                        ...
                                        <input type="text" name="lastname" id="inputLastName" class="field form-control"
                                            placeholder="{$LANG.orderForm.lastName}" required
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <input type="text" name="postcode" id="inputPostcode" class="field form-control"
                                            placeholder="{$LANG.orderForm.postcode}" required
                ...
                <div class="text-center">
                    ...
                    <script>
                        function showSpinner(event) {
                            ...
                            requiredFields.forEach((field) => {
                                if (!field.value
                                    .trim()) { // Garantir que o valor não esteja vazio ou apenas com espaços
                                    formIsValid = false;
                            ...
                            if (fullName && fullName.value.trim().split(" ").length < 2) {
                                formIsValid = false;
                                missingFields.push("{$LANG.fullNameError}"); // Adiciona a mensagem traduzida ao modal
                                fullName.classList.add('invalid-field'); // Adiciona a borda vermelha no campo de nome completo
                            }
                            ...
                            if (password1 && password2 && password1.value !== password2.value) {
                                formIsValid = false;
                                missingFields.push("{$LANG.passwordsDoNotMatch}"); // Adiciona a mensagem traduzida ao modal
                                password1.classList.add('invalid-field'); // Adiciona a borda vermelha na senha
                                password2.classList.add('invalid-field'); // Adiciona a borda vermelha na confirmação de senha
                            }
                        ...
                        function showErrorModal(missingFields) {
                            ...
                            missingFields.forEach((field) => {
                                // Verifica se o campo não é vazio antes de adicioná-lo
                                if (field && field.trim()) {
