function scrollToGatewayInputError(){var e=jQuery(".gateway-errors,.assisted-cc-input-feedback").first(),t=e.closest("form");t||(t=jQuery("form").first()),t.find('button[type="submit"],input[type="submit"]').prop("disabled",!1).removeClass("disabled").find("i.fas,i.far,i.fal,i.fab").removeAttr("class").addClass("fas fa-arrow-circle-right").find("span").toggle(),e.length&&elementOutOfViewPort(e[0])&&jQuery("html, body").animate({scrollTop:e.offset().top-50},500)}function elementOutOfViewPort(e){var t=e.getBoundingClientRect(),n={};return n.top=t.top<0,n.left=t.left<0,n.bottom=t.bottom>(window.innerHeight||document.documentElement.clientHeight),n.right=t.right>(window.innerWidth||document.documentElement.clientWidth),n.any=n.top||n.left||n.bottom||n.right,n.any}!function(e){var t="iCheck",n=t+"-helper",i="checkbox",a="radio",r="checked",o="un"+r,s="disabled",d="determinate",l="in"+d,u="update",c="type",h="click",p="touchbegin.i touchend.i",f="addClass",m="removeClass",y="trigger",g="label",v="cursor",j=/ip(hone|od|ad)|android|blackberry|windows phone|opera mini|silk/i.test(navigator.userAgent)||"MacIntel"===navigator.platform&&navigator.maxTouchPoints>1;function C(e,t,n){var i=e[0],o=/er/.test(n)?l:/bl/.test(n)?s:r,h=n==u?{checked:i[r],disabled:i[s],indeterminate:"true"==e.attr(l)||"false"==e.attr(d)}:i[o];if(/^(ch|di|in)/.test(n)&&!h)b(e,o);else if(/^(un|en|de)/.test(n)&&h)w(e,o);else if(n==u)for(var p in h)h[p]?b(e,p,!0):w(e,p,!0);else t&&"toggle"!=n||(t||e[y]("ifClicked"),h?i[c]!==a&&w(e,o):b(e,o))}function b(i,u,h){var p=i[0],y=i.parent(),g=u==r,j=u==l,C=u==s,b=j?d:g?o:"enabled",Q=k(i,b+S(p[c])),x=k(i,u+S(p[c]));if(!0!==p[u]){if(!h&&u==r&&p[c]==a&&p.name){var D=i.closest("form"),T='input[name="'+p.name+'"]';(T=D.length?D.find(T):e(T)).each((function(){this!==p&&e(this).data(t)&&w(e(this),u)}))}j?(p[u]=!0,p[r]&&w(i,r,"force")):(h||(p[u]=!0),g&&p[l]&&w(i,l,!1)),M(i,g,u,h)}p[s]&&k(i,v,!0)&&y.find("."+n).css(v,"default"),y[f](x||k(i,u)||""),y.attr("role")&&!j&&y.attr("aria-"+(C?s:r),"true"),y[m](Q||k(i,b)||"")}function w(e,t,i){var a=e[0],u=e.parent(),h=t==r,p=t==l,y=t==s,g=p?d:h?o:"enabled",j=k(e,g+S(a[c])),C=k(e,t+S(a[c]));!1!==a[t]&&(!p&&i&&"force"!=i||(a[t]=!1),M(e,h,g,i)),!a[s]&&k(e,v,!0)&&u.find("."+n).css(v,"pointer"),u[m](C||k(e,t)||""),u.attr("role")&&!p&&u.attr("aria-"+(y?s:r),"false"),u[f](j||k(e,g)||"")}function Q(n,i){n.data(t)&&(n.parent().html(n.attr("style",n.data(t).s||"")),i&&n[y](i),n.off(".i").unwrap(),e(g+'[for="'+n[0].id+'"]').add(n.closest(g)).off(".i"))}function k(e,n,i){if(e.data(t))return e.data(t).o[n+(i?"":"Class")]}function S(e){return e.charAt(0).toUpperCase()+e.slice(1)}function M(e,t,n,i){i||(t&&e[y]("ifToggled"),e[y]("change")[y]("ifChanged")[y]("if"+S(n)))}e.fn[t]=function(o,d){var v='input[type="'+i+'"], input[type="'+a+'"]',k=e(),S=function(t){t.each((function(){var t=e(this);k=t.is(v)?k.add(t):k.add(t.find(v))}))};if(/^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(o))return o=o.toLowerCase(),S(this),k.each((function(){var t=e(this);"destroy"==o?Q(t,"ifDestroyed"):C(t,!0,o),e.isFunction(d)&&d()}));if("object"!=typeof o&&o)return this;var M=e.extend({checkedClass:r,disabledClass:s,indeterminateClass:l,labelHover:!0},o),x=M.handle,D=M.hoverClass||"hover",T=M.focusClass||"focus",R=M.activeClass||"active",U=!!M.labelHover,H=M.labelHoverClass||"hover",W=0|(""+M.increaseArea).replace("%","");return x!=i&&x!=a||(v='input[type="'+x+'"]'),W<-50&&(W=-50),S(this),k.each((function(){var o=e(this);Q(o);var d,l=this,v=l.id,k=-W+"%",S=100+2*W+"%",x={position:"absolute",top:k,left:k,display:"block",width:S,height:S,margin:0,padding:0,background:"#fff",border:0,opacity:0},P=j?{position:"absolute",visibility:"hidden"}:W?x:{position:"absolute",opacity:0},A=l[c]==i?M.checkboxClass||"i"+i:M.radioClass||"i"+a,L=e(g+'[for="'+v+'"]').add(o.closest(g)),I=!!M.aria,E=t+"-"+Math.random().toString(36).substr(2,6),O='<div class="'+A+'" '+(I?'role="'+l[c]+'" ':"");I&&L.each((function(){O+='aria-labelledby="',this.id?O+=this.id:(this.id=E,O+=E),O+='"'})),O=o.wrap(O+"/>")[y]("ifCreated").parent().append(M.insert),d=e('<ins class="'+n+'"/>').css(x).appendTo(O),o.data(t,{o:M,s:o.attr("style")}).css(P),M.inheritClass&&O[f](l.className||""),M.inheritID&&v&&O.attr("id",t+"-"+v),"static"==O.css("position")&&O.css("position","relative"),C(o,!0,u),L.length&&L.on(h+".i mouseover.i mouseout.i "+p,(function(t){var n=t[c],i=e(this);if(!l[s]){if(n==h){if(e(t.target).is("a"))return;C(o,!1,!0)}else U&&(/ut|nd/.test(n)?(O[m](D),i[m](H)):(O[f](D),i[f](H)));if(!j)return!1;t.stopPropagation()}})),o.on(h+".i focus.i blur.i keyup.i keydown.i keypress.i",(function(e){var t=e[c],n=e.keyCode;return t!=h&&("keydown"==t&&32==n?(l[c]==a&&l[r]||(l[r]?w(o,r):b(o,r)),!1):void("keyup"==t&&l[c]==a?!l[r]&&b(o,r):/us|ur/.test(t)&&O["blur"==t?m:f](T)))})),d.on(h+" mousedown mouseup mouseover mouseout "+p,(function(e){var t=e[c],n=/wn|up/.test(t)?R:D;if(!l[s]){if(t==h?C(o,!1,!0):(/wn|er|in/.test(t)?O[f](n):O[m](n+" "+R),L.length&&U&&n==D&&L[/ut|nd/.test(t)?m:f](H)),!j)return!1;e.stopPropagation()}}))}))}}(window.jQuery||window.Zepto),
