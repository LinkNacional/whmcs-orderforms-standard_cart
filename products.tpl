                        ...
                        <div class="col-md-6">
                            <div class="product clearfix" id="{$idPrefix}">
                                ...
                                <footer>
                                    ...
                                    <a href="{$product.productUrl}" class="btn btn-success btn-sm btn-order-now"
                                        id="{$idPrefix}-order-button" {if $product.hasRecommendations}
                                        data-has-recommendations="1" {/if}>
